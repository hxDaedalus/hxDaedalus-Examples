...
var BitmapPathfinding04js = function() {
	...
	this.imageLoader = new hxDaedalus.graphics.js.ImageLoader([this.galapagosBW66encoded,"assets/galapagosColor.png"],$bind(this,this.onLoaded));
};
BitmapPathfinding04js.__name__ = true;
BitmapPathfinding04js.main = function() {
	new BitmapPathfinding04js();
};
BitmapPathfinding04js.prototype = {
	onLoaded: function() {
...
hxDaedalus.data.graph.Graph.__name__ = true;
...
hxDaedalus.data.graph.GraphEdge.__name__ = true;
...
hxDaedalus.data.graph.GraphNode.__name__ = true;
...
hxDaedalus.data.math.EdgeData.__name__ = true;
...
hxDaedalus.data.math.NodeData.__name__ = true;
hxDaedalus.data.math.Potrace = function() {
};
hxDaedalus.data.math.Potrace.__name__ = true;
...
hxDaedalus.data.math.ShapeSimplifier.__name__ = true;
...
hxDaedalus.factories.BitmapObject.__name__ = true;
...
hxDaedalus.graphics.js.CanvasPixelMatrix.__name__ = true;
hxDaedalus.graphics.js.CanvasPixelMatrix.createCanvasPixelMatrixFromContext = function(context,w_,h_) {
	var imageData = context.getImageData(0,0,w_,h_);
	var dataIn = imageData.data;
	return new hxDaedalus.graphics.js.CanvasPixelMatrix(dataIn,w_,h_);
};
hxDaedalus.graphics.js.CanvasPixelMatrix.prototype = {
...
hxDaedalus.graphics.js.ImageLoader = function(imageNames,loaded_) {
...
hxDaedalus.graphics.js.ImageLoader.__name__ = true;
hxDaedalus.graphics.js.ImageLoader.prototype = {
	load: function(img) {
		var image;
		var _this = window.document;
	...
	,store: function(image,name,e) {
		this.count--;
		haxe.Log.trace("store " + name + " " + this.count,{ fileName : "ImageLoader.hx", lineNumber : 67, className : "hxDaedalus.graphics.js.ImageLoader", methodName : "store"});
